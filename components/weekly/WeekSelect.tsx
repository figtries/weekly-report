  ...
  return (
    <div ref={rootRef} className="relative w-fit">
      <button
        ...
        aria-expanded={open}
        className="flex items-center gap-2 rounded-lg py-1.5 text-sm font-medium tabular-nums text-gray-900 transition-all duration-200 ease-ios focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40 active:scale-[0.98] sm:border sm:border-gray-300 sm:bg-white sm:pl-3 sm:pr-2.5 sm:shadow-sm sm:hover:border-gray-400 sm:hover:shadow"
      >
